...
public class SkuController {
	...
	/**
	 *  保存属性与属性值
	 * @param sku,T_MALL_SKU
	 * @param list_attr, MODEL_T_MALL_SKU_ATTR_VALUE
	 * @param spu,T_MALL_PRODUCT
	 * @param map
	 * @return
	 */
	...
	@RequestMapping("goto_sku_query")
	public String goto_sku_query(int flbh1, int flbh2, ModelMap map) {
